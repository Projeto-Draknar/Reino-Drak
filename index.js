...
const config = {
    A187: 'Kai Saints',
    Instagram: 'https://www.instagram.com/invites/contact/?i=1278wj4jcu4gn&utm_content=j82xo4l',
    Numero: 'wa.me/+5547991570665',
    Ativo: '14 de fevereiro de 2021',
    YouTube: 'https://youtube.com/channel/UCRaC-6JyCW_iqbW1DbuXVxQ',
    WhatsApp: 'https://chat.whatsapp.com/I6g8g01XW5O7K3Lg2y36eJ',
       ...
       case 'ytmp3':
           ytdl('mp3', value)
               .then(data => {
                   ...
                   let hasil = `OL�0�9 AQUI EST�0�9 O LINK DE DOWNLOAD DA M�0�3SICA\nCLIQUE NO LINK ABAIXO:\nM�0�3SICA: ${judul}\n\nTamanho do ��udio: ${size}\n\nLink: ${link}`
                   client.sendMessage(id, '[ESPERE UM POUCO...', MessageType.text)
       ...
       case 'covid':
           corona()
               .then(data => {
                   ...
                   let hasil = `ULTIMOS DADOS DO DISTRITO COVID-19 DA INDON�0�7SIA\n\nPositivo ==> ${positif} \nCurado ==> ${sembuh} \nMorreu ==> ${meninggal}`
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
